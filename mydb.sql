...
CREATE TABLE `comment` (
  `ID` int(100) NOT NULL,
  `日時` date NOT NULL,
  `号館` varchar(30) NOT NULL,
  `商品名` varchar(100) NOT NULL,
  `コメント` varchar(200) NOT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `comment2` (
  `ID` int(100) NOT NULL,
  `日時` varchar(100) NOT NULL,
  `号館` varchar(100) NOT NULL,
  `商品名` varchar(100) NOT NULL,
  `コメント` varchar(200) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Dump completed on 2023-06-30 18:00:56
